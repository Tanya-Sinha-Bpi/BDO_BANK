export const sendLink=(name,link)=>{
    return `
    <!DOCTYPE html>
...
<div style="color:#ffffff;font-family:'Varela Round', 'Trebuchet MS', Helvetica, sans-serif;font-size:12px;line-height:150%;text-align:center;mso-line-height-alt:21px;">
	<p style="margin: 0; word-break: break-word;">Note : This Reset Password Link is Valid for only 10 Minutes</p> </div>
</td>
</tr>
</table>
...
<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href=${link} style="height:30px;width:197px;v-text-anchor:middle;" arcsize="80%" stroke="false" fillcolor="#ffffff">
<w:anchorlock/>
...
<p style="margin: 0; word-break: break-word;">If you haven't changed your password, reach out to us right away.</p>
</div>
</td>
</tr>
</table>
