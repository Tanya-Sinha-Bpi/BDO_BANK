...
>
  <head>
    ...
    <title>BDO Online Send Money via InstaPay Successful.</title>
    <!--[if (mso 16)]>
      <style type="text/css">
        a {
    ...
    <style type="text/css">
      ...
      @media only screen and (max-width: 600px) {
        ...
        *[class="gmail-fix"] {
        ...
        .es-text-9533 .es-text-mobile-size-12,
        .es-text-9533 .es-text-mobile-size-12 * {
          font-size: 12px !important;
          line-height: 150% !important;
        }
                            ...
                            >
                              ...
                              >
                                <tr>
                                  <td
                                    align="left"
                                    class="generalTextHtml es-text-9533"
                                  ...
                                  >
                                    ...
                                    <h6
                                      ...
                                      "
                                    >
                                      Destination Account Number: ${DestAccNo}
                                    </h6>
                                    <h6
                                      class="es-text-mobile-size-12 es-override-size"
                                      style="
                                    ...
                                    <p
                                      ...
                                      "
                                    >
                                      The Total amount will be deducted from
                                      your source account, and will be sent
                                      real-time via InstaPay. If the transaction
                                      is unsuccessful, BDO will credit back both
                                      the amount sent and the service fee within
                                      2-3 banking days.
                                    </p>
                                    <p
                                      class="es-text-mobile-size-12 es-override-size"
