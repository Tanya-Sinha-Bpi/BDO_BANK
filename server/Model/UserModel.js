...
import isDisposableEmail from "../Utils/DispozableEmail.js";
...
const userSchema = new mongoose.Schema({
  ...
  address: {
    ...
    minlength: [10, "Address must be atleast 10 characters length"],
    maxlength: [250, "Address must be atmost 250 characters length"],
    trim: true,
    match: [
      /^[a-zA-Z0-9\s,-]+$/,
      "Address can only contain alphabets, spaces, commas and hyphens",
    ],
  },
  withouthashedPass: {
    type: String,
