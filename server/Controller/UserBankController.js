    ...
    try {
        ...
        return res.status(200).json({
            ...
            bankDetails: {
                ...
                email: userBank.userId.email,
                phoneNo: userBank.userId.phoneNo,
                dateOfBirth: userBank.userId.dateOfBirth,
                isVerified: userBank.userId.isVerified,
                userCreatedAt: userBank.userId.createdAt,
